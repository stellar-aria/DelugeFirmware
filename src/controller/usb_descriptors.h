...
// Based on TinyUSB UAC2 headset example
#define TUD_AUDIO_HEADSET_STEREO_DESC_LEN                                                                              \
	(TUD_AUDIO_DESC_IAD_LEN + TUD_AUDIO_DESC_STD_AC_LEN + TUD_AUDIO_DESC_CS_AC_LEN + TUD_AUDIO_DESC_CLK_SRC_LEN        \
	 ...
	 + TUD_AUDIO_DESC_STD_AS_ISO_EP_LEN + TUD_AUDIO_DESC_CS_AS_ISO_EP_LEN + /* Interface 2, Alternate 0 */             \
	 TUD_AUDIO_DESC_STD_AS_INT_LEN +                                        /* Interface 2, Alternate 1 */             \
	 TUD_AUDIO_DESC_STD_AS_INT_LEN + TUD_AUDIO_DESC_CS_AS_INT_LEN + TUD_AUDIO_DESC_TYPE_I_FORMAT_LEN                   \
	 + TUD_AUDIO_DESC_STD_AS_ISO_EP_LEN + TUD_AUDIO_DESC_CS_AS_ISO_EP_LEN)

// Audio descriptor macro - simplified to single format (16-bit @ 44.1kHz)
#define TUD_AUDIO_HEADSET_STEREO_DESCRIPTOR(_stridx, _epout, _epin)                                                    \
	/* Standard Interface Association Descriptor (IAD) */                                                              \
	TUD_AUDIO_DESC_IAD(/*_firstitf*/ ITF_NUM_AUDIO_CONTROL, /*_nitfs*/ 3,                                              \
	    ...
	    TUD_AUDIO_DESC_CS_AC(/*_bcdADC*/ 0x0200, /*_category*/ AUDIO_FUNC_HEADSET, /*_totallen*/                       \
	    ...
	    TUD_AUDIO_DESC_FEATURE_UNIT_TWO_CHANNEL(                                                                       \
	        /*_unitid*/ UAC2_ENTITY_SPK_FEATURE_UNIT, /*_srcid*/ UAC2_ENTITY_SPK_INPUT_TERMINAL, /*_ctrlch0master*/    \
	    ...
	    TUD_AUDIO_DESC_OUTPUT_TERM(                                                                                    \
	        ...
	        /*_ctrl*/ 0x0000,                                                                                          \
	        /*_stridx*/ 0x00), /* Input Terminal Descriptor(4.7.2.4) - Deluge to USB (mic/line input) */               \
	    ...
	    TUD_AUDIO_DESC_STD_AS_INT(/*_itfnum*/ (uint8_t)(ITF_NUM_AUDIO_STREAMING_SPK), /*_altset*/ 0x00,                \
	    ...
	    TUD_AUDIO_DESC_STD_AS_INT(/*_itfnum*/ (uint8_t)(ITF_NUM_AUDIO_STREAMING_SPK), /*_altset*/ 0x01,                \
	                              /*_nEPs*/ 0x01,                                                                      \
	                              /*_stridx*/ 0x00), /* Class-Specific AS Interface Descriptor(4.9.2) */               \
	    TUD_AUDIO_DESC_CS_AS_INT(/*_termid*/ UAC2_ENTITY_SPK_INPUT_TERMINAL, /*_ctrl*/ AUDIO_CTRL_NONE,                \
	    ...
	    /* Standard AS Interface Descriptor(4.9.1) */ /* Interface 2, Alternate 0 -                                    \
	                                                     default alternate setting with 0                              \
	                                                     bandwidth */                                                  \
	    TUD_AUDIO_DESC_STD_AS_INT(/*_itfnum*/ (uint8_t)(ITF_NUM_AUDIO_STREAMING_MIC), /*_altset*/ 0x00,                \
	                              /*_nEPs*/ 0x00, /*_stridx*/ 0x00),                                                   \
	    /* Standard AS Interface Descriptor(4.9.1) */ /* Interface 2, Alternate 1 - alternate                          \
	                                                     interface for data streaming */                               \
	    TUD_AUDIO_DESC_STD_AS_INT(/*_itfnum*/ (uint8_t)(ITF_NUM_AUDIO_STREAMING_MIC), /*_altset*/ 0x01,                \
	                              /*_nEPs*/ 0x01,                                                                      \
	                              /*_stridx*/ 0x00), /* Class-Specific AS Interface Descriptor(4.9.2) */               \
	    TUD_AUDIO_DESC_CS_AS_INT(/*_termid*/ UAC2_ENTITY_MIC_OUTPUT_TERMINAL, /*_ctrl*/ AUDIO_CTRL_NONE,               \
	                             /*_formattype*/ AUDIO_FORMAT_TYPE_I, /*_formats*/ AUDIO_DATA_FORMAT_TYPE_I_PCM,       \
