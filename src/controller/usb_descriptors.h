...
// Speaker path (audio output from Deluge)
#define UAC2_ENTITY_SPK_INPUT_TERMINAL 0x01
#define UAC2_ENTITY_SPK_FEATURE_UNIT 0x02
#define UAC2_ENTITY_SPK_OUTPUT_TERMINAL 0x03
// Microphone/Line Input path (audio input to Deluge)
#define UAC2_ENTITY_MIC_INPUT_TERMINAL 0x11
#define UAC2_ENTITY_MIC_OUTPUT_TERMINAL 0x13

// Interface numbers (must match descriptor order)
// Audio first for Windows UAC2 driver compatibility
// CDC and MIDI temporarily disabled for testing
enum {
	ITF_NUM_AUDIO_CONTROL = 0,
	ITF_NUM_AUDIO_STREAMING_SPK,
	ITF_NUM_AUDIO_STREAMING_MIC,
	ITF_NUM_TOTAL // Only 3 interfaces when testing audio-only
	              // ITF_NUM_CDC,
	              // ITF_NUM_CDC_DATA,
	              // ITF_NUM_MIDI,
...
// Audio descriptor length calculation - includes AC interrupt endpoint and BOTH alternate settings
// Based on TinyUSB UAC2 headset example with dual format support
#define TUD_AUDIO_HEADSET_STEREO_DESC_LEN                                                                              \
	(TUD_AUDIO20_DESC_IAD_LEN + TUD_AUDIO20_DESC_STD_AC_LEN + TUD_AUDIO20_DESC_CS_AC_LEN                               \
	 ...
	 + TUD_AUDIO20_DESC_STD_AS_ISO_EP_LEN + TUD_AUDIO20_DESC_CS_AS_ISO_EP_LEN /* Interface 1, Alternate 2 */           \
	 + TUD_AUDIO20_DESC_STD_AS_LEN + TUD_AUDIO20_DESC_CS_AS_INT_LEN + TUD_AUDIO20_DESC_TYPE_I_FORMAT_LEN               \
	 + TUD_AUDIO20_DESC_STD_AS_ISO_EP_LEN + TUD_AUDIO20_DESC_CS_AS_ISO_EP_LEN /* Interface 2, Alternate 0 */           \
	 + TUD_AUDIO20_DESC_STD_AS_LEN                                            /* Interface 2, Alternate 1 */           \
	 + TUD_AUDIO20_DESC_STD_AS_LEN + TUD_AUDIO20_DESC_CS_AS_INT_LEN + TUD_AUDIO20_DESC_TYPE_I_FORMAT_LEN               \
	 + TUD_AUDIO20_DESC_STD_AS_ISO_EP_LEN + TUD_AUDIO20_DESC_CS_AS_ISO_EP_LEN /* Interface 2, Alternate 2 */           \
	 + TUD_AUDIO20_DESC_STD_AS_LEN + TUD_AUDIO20_DESC_CS_AS_INT_LEN + TUD_AUDIO20_DESC_TYPE_I_FORMAT_LEN               \
	 + TUD_AUDIO20_DESC_STD_AS_ISO_EP_LEN + TUD_AUDIO20_DESC_CS_AS_ISO_EP_LEN)

// Audio descriptor macro - stereo speaker output + mono mic input with dual format support (16-bit and 24-bit)
#define TUD_AUDIO_HEADSET_STEREO_DESCRIPTOR(_stridx, _epout, _epin, _epint)                                            \
	...
	TUD_AUDIO20_DESC_IAD(/*_firstitf*/ ITF_NUM_AUDIO_CONTROL, /*_nitfs*/ 3,                                            \
	    ...
	    TUD_AUDIO20_DESC_INPUT_TERM(                                                                                   \
	        /*_termid*/ UAC2_ENTITY_SPK_INPUT_TERMINAL, /*_termtype*/ AUDIO20_TERM_TYPE_USB_STREAMING,                 \
	        /*_assocTerm*/ UAC2_ENTITY_MIC_OUTPUT_TERMINAL, /*_clkid*/ UAC2_ENTITY_CLOCK, /*_nchannelslogical*/ 0x02,  \
	    ...
	    TUD_AUDIO20_DESC_OUTPUT_TERM(                                                                                  \
	        /*_termid*/ UAC2_ENTITY_SPK_OUTPUT_TERMINAL, /*_termtype*/ AUDIO20_TERM_TYPE_OUT_HEADPHONES,               \
	        /*_assocTerm*/ 0x00, /*_srcid*/ UAC2_ENTITY_SPK_FEATURE_UNIT, /*_clkid*/ UAC2_ENTITY_CLOCK,                \
	        /*_ctrl*/ 0x0000, /*_stridx*/ 0x00), /* Input Terminal Descriptor(4.7.2.4) - Deluge to USB (mic input) */  \
	    TUD_AUDIO20_DESC_INPUT_TERM(/*_termid*/ UAC2_ENTITY_MIC_INPUT_TERMINAL,                                        \
	                                /*_termtype*/ AUDIO20_TERM_TYPE_IN_GENERIC_MIC, /*_assocTerm*/ 0x00,               \
	                                /*_clkid*/ UAC2_ENTITY_CLOCK, /*_nchannelslogical*/ 0x01,                          \
	                                /*_channelcfg*/ AUDIO20_CHANNEL_CONFIG_NON_PREDEFINED, /*_idxchannelnames*/ 0x00,  \
	                                /*_ctrl*/ 0 * (AUDIO20_CTRL_R << AUDIO20_IN_TERM_CTRL_CONNECTOR_POS),              \
	                                /*_stridx*/ 0x00), /* Output Terminal Descriptor(4.7.2.5) */                       \
	    TUD_AUDIO20_DESC_OUTPUT_TERM(                                                                                  \
	        /*_termid*/ UAC2_ENTITY_MIC_OUTPUT_TERMINAL, /*_termtype*/ AUDIO20_TERM_TYPE_USB_STREAMING,                \
	        /*_assocTerm*/ UAC2_ENTITY_SPK_INPUT_TERMINAL, /*_srcid*/ UAC2_ENTITY_MIC_INPUT_TERMINAL,                  \
	    ...
	    /* ===== Interface 1: Speaker Streaming ===== */ /* Standard AS Interface                                      \
	                                                        ...
	                                                        Alternate 0 (idle) */                                      \
	    TUD_AUDIO20_DESC_STD_AS(/*_itfnum*/ (uint8_t)(ITF_NUM_AUDIO_STREAMING_SPK), /*_altset*/ 0x00, /*_nEPs*/ 0x00,  \
	                            /*_stridx*/ 0x05), /* Standard AS Interface Descriptor(4.9.1) - Interface 1, Alternate \
	                                                  1 (16-bit format) */                                             \
	    TUD_AUDIO20_DESC_STD_AS(/*_itfnum*/ (uint8_t)(ITF_NUM_AUDIO_STREAMING_SPK), /*_altset*/ 0x01, /*_nEPs*/ 0x01,  \
	                            /*_stridx*/ 0x05), /* Class-Specific AS Interface Descriptor(4.9.2) */                 \
	    TUD_AUDIO20_DESC_CS_AS(/*_termid*/ UAC2_ENTITY_SPK_INPUT_TERMINAL, /*_ctrl*/ AUDIO20_CTRL_NONE,                \
	    ...
	    TUD_AUDIO20_DESC_STD_AS(/*_itfnum*/ (uint8_t)(ITF_NUM_AUDIO_STREAMING_SPK), /*_altset*/ 0x02, /*_nEPs*/ 0x01,  \
	                            /*_stridx*/ 0x05), /* Class-Specific AS Interface Descriptor(4.9.2) */                 \
	    TUD_AUDIO20_DESC_CS_AS(/*_termid*/ UAC2_ENTITY_SPK_INPUT_TERMINAL, /*_ctrl*/ AUDIO20_CTRL_NONE,                \
	                           /*_formattype*/ AUDIO20_FORMAT_TYPE_I, /*_formats*/ AUDIO20_DATA_FORMAT_TYPE_I_PCM,     \
	                           /*_nchannelsphysical*/ CFG_TUD_AUDIO_FUNC_1_N_CHANNELS_RX,                              \
	    ...
	    /* ===== Interface 2: Microphone Streaming ===== */ /* Standard AS Interface                                   \
	                                                           Descriptor(4.9.1) -                                     \
	                                                           Interface 2, Alternate 0                                \
	                                                           (idle) */                                               \
	    TUD_AUDIO20_DESC_STD_AS(/*_itfnum*/ (uint8_t)(ITF_NUM_AUDIO_STREAMING_MIC), /*_altset*/ 0x00, /*_nEPs*/ 0x00,  \
	                            /*_stridx*/ 0x04), /* Standard AS Interface Descriptor(4.9.1) - Interface 2, Alternate \
	                                                  1 (16-bit format) */                                             \
	    TUD_AUDIO20_DESC_STD_AS(/*_itfnum*/ (uint8_t)(ITF_NUM_AUDIO_STREAMING_MIC), /*_altset*/ 0x01, /*_nEPs*/ 0x01,  \
	                            /*_stridx*/ 0x04), /* Class-Specific AS Interface Descriptor(4.9.2) */                 \
	    TUD_AUDIO20_DESC_CS_AS(/*_termid*/ UAC2_ENTITY_MIC_OUTPUT_TERMINAL, /*_ctrl*/ AUDIO20_CTRL_NONE,               \
	                           /*_formattype*/ AUDIO20_FORMAT_TYPE_I, /*_formats*/ AUDIO20_DATA_FORMAT_TYPE_I_PCM,     \
	    ...
	    TUD_AUDIO20_DESC_TYPE_I_FORMAT(                                                                                \
	        ...
	        CFG_TUD_AUDIO_FUNC_1_FORMAT_1_RESOLUTION_TX), /* Standard AS Isochronous Audio Data Endpoint               \
	                                                         Descriptor(4.10.1.1) */                                   \
	    TUD_AUDIO20_DESC_STD_AS_ISO_EP(                                                                                \
	        /*_ep*/ _epin, /*_attr*/                                                                                   \
	    ...
	    TUD_AUDIO20_DESC_CS_AS_ISO_EP(/*_attr*/ AUDIO20_CS_AS_ISO_DATA_EP_ATT_NON_MAX_PACKETS_OK,                      \
	                                  ...
	                                  /*_lockdelay*/ 0x0000), /* Standard AS Interface Descriptor(4.9.1) - Interface   \
	                                                             2, Alternate 2 (24-bit format) */                     \
	    TUD_AUDIO20_DESC_STD_AS(/*_itfnum*/ (uint8_t)(ITF_NUM_AUDIO_STREAMING_MIC), /*_altset*/ 0x02, /*_nEPs*/ 0x01,  \
	                            /*_stridx*/ 0x04), /* Class-Specific AS Interface Descriptor(4.9.2) */                 \
	    TUD_AUDIO20_DESC_CS_AS(/*_termid*/ UAC2_ENTITY_MIC_OUTPUT_TERMINAL, /*_ctrl*/ AUDIO20_CTRL_NONE,               \
	                           /*_formattype*/ AUDIO20_FORMAT_TYPE_I, /*_formats*/ AUDIO20_DATA_FORMAT_TYPE_I_PCM,     \
	                           /*_nchannelsphysical*/ CFG_TUD_AUDIO_FUNC_1_N_CHANNELS_TX,                              \
	    ...
	    TUD_AUDIO20_DESC_TYPE_I_FORMAT(                                                                                \
	        ...
	        CFG_TUD_AUDIO_FUNC_1_FORMAT_2_RESOLUTION_TX), /* Standard AS Isochronous Audio Data Endpoint               \
	                                                         Descriptor(4.10.1.1) */                                   \
	    TUD_AUDIO20_DESC_STD_AS_ISO_EP(                                                                                \
	        /*_ep*/ _epin, /*_attr*/                                                                                   \
	        (uint8_t)((uint8_t)TUSB_XFER_ISOCHRONOUS | (uint8_t)TUSB_ISO_EP_ATT_ASYNCHRONOUS                           \
