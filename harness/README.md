...
- **`harness/rust/`** — harnesses whose subject is a `crates/` library or
  ...
  The cost of that exception is a four-level `#[path]` reach that breaks if the
